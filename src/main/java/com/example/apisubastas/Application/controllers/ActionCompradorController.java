...
public class ActionCompradorController {

    private final SubastaConverter subastaConverter;
    private final AccionesCompradorService actionCompradorService;

    public ActionCompradorController(SubastaConverter subastaConverter, AccionesCompradorService actionCompradorService) {
